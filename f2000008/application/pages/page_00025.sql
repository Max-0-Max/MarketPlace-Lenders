...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77693096633042095)
...
,p_location=>null
,p_menu_id=>wwv_flow_imp.id(80649733971461634)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(77693702134042096)
...
'AND B.PERSON_ID = NVL(:P25_EMPLOYEE,B.PERSON_ID)',
'AND A.LOAN_STATUS = NVL(:P25_STATUS,A.LOAN_STATUS)',
'AND (',
'    (:P25_START_DATE IS NULL OR TRUNC(A.START_DATE) >= TRUNC(TO_DATE(:P25_START_DATE, ''MM/DD/YYYY''))) AND',
'    (:P25_END_DATE   IS NULL OR TRUNC(A.END_DATE)   <= TRUNC(TO_DATE(:P25_END_DATE, ''MM/DD/YYYY'')))',
')',
'',
''))
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(77693840403042096)
,p_name=>'Loan Rejection Report'
...
,p_download_filename=>'Loan Rejection Report'
,p_enable_mail_download=>'Y'
,p_owner=>'DADEGBITE'
,p_internal_uid=>77693840403042096
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(77748524859066841)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80237843354938801)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80238559009938808)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80238672052938809)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(80238714454938810)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(79399635513656978)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(76629027734284333)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(77693702134042096)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76628627421284329)
,p_name=>'P25_END_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(77693702134042096)
,p_prompt=>'End Date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76628799074284330)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76628888695284331)
,p_name=>'P25_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(77693702134042096)
,p_prompt=>'New'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(76628938307284332)
,p_name=>'P25_EMPLOYEE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(77693702134042096)
,p_prompt=>'Employee'

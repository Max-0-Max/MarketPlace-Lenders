...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(190210038255842561)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(190210953033842570)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(190211856605842579)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(149230885576210503)
,p_plug_name=>'Users'
,p_region_name=>'users'
,p_parent_plug_id=>wwv_flow_imp.id(190211856605842579)
...
'    v_item         VARCHAR2(100) := ''''''P17_USERS_OFFSET'''''';',
...
'                  <button class="add-btn" onclick="return redirectToModalPageCreateProduct(7,'' || :P17_COMPANY_ID || '','' || v_type || '')">Add New User</button>',
'                </div>',
'              </div>',
'',
...
,p_lazy_loading=>false
,p_plug_source_type=>'NATIVE_DYNAMIC_CONTENT'
,p_ajax_items_to_submit=>'P17_USERS_OFFSET'
,p_ai_enabled=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(190211932045842580)
...
'                    <button class="edit-button" onclick="return redirectToModal(4,''||i.company_id||'')"> ',
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(190212053540842581)
...
'    v_item         VARCHAR2(100) := ''''''P17_PROD_OFFSET'''''';',
'    v_region         VARCHAR2(100) := ''''''products'''''';',
'BEGIN',
'',
'    BEGIN',
'        v_offset := TO_NUMBER(:P17_PROD_OFFSET);',
'    EXCEPTION',
...
'              <div class="showing">',
'                <span>Showing</span>',
'                <select id="page-select" onchange="handlePageChange(this,''|| v_process || '', '' || v_item || '', ''||v_region||'','' || v_count || '')">'');',
'',
'                    FOR i IN 1..v_count LOOP',
'                        IF i = v_offset THEN',
'                            htp.p(''<option value="'' || i || ''" selected>'' || i || ''</option>'');',
...
'',
'                            FOR i IN 1..v_count LOOP',
'                                htp.p(''<button onclick="return getData('' || i || '', '' || v_process || '', '' || v_region || '','' || v_count || '')">'' || i || ''</button>'');',
'                            END LOOP;',
'',
'                            htp.p(''<button onclick="return apprPaginate(1, '' || v_process || '', '' || v_item || '', '' || v_region || '','' || v_count || '')">&gt;</button>',
'                    </div>'');',
...
,p_lazy_loading=>false
,p_plug_source_type=>'NATIVE_DYNAMIC_CONTENT'
,p_ajax_items_to_submit=>'P17_PROD_OFFSET'
,p_ai_enabled=>false
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(190212168149842583)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(213213789096619661)
...
'    v_type         NUMBER; -- 1 is for loan services',
'    v_count        NUMBER;',
'    v_offset       NUMBER := NVL(:P17_APPR_OFFSET, 1);',
'    v_page_size    NUMBER := 5;',
'    v_process      VARCHAR2(200) := ''''''GET_APPROVERS_DATA'''''';',
'    v_item         VARCHAR2(100) := ''''''P17_APPR_OFFSET'''''';',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75775130983656723)
,p_name=>'P17_USERS_OFFSET'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(190210953033842570)
,p_item_default=>'1'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75775328233656725)
,p_name=>'P17_PROD_OFFSET'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(190210953033842570)
,p_item_default=>'1'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(75775484863656726)
,p_name=>'P17_APPR_OFFSET'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(190210953033842570)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(190218493977842759)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(76626002091284303)
...
'       ',
'        IF :P1_APPROVAL_LEVEL BETWEEN 1 AND 4 THEN',
'          ',
'           ',
'            IF :P1_APPROVAL_LEVEL > v_max + 1 THEN',
'                RAISE_APPLICATION_ERROR(-20001, ''Approval flow must follow each other sequentially.'');',
'            END IF;',
'        ELSE',
'    ',
'            DBMS_OUTPUT.PUT_LINE (''You have opted for no approval flow or the approval level is not specified.'');',
'        END IF;',
'    ELSE',
'        DBMS_OUTPUT.PUT_LINE (''Setup initiated'');',
'    END IF;',
'',
'END;'))
,p_validation_type=>'PLSQL_ERROR'
,p_error_message=>'Approval flow must follow each other sequentially.'
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(75845030531150605)
,p_name=>'New'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(75845583509150607)
,p_event_id=>wwv_flow_imp.id(75845030531150605)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75843475528150601)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'New'
,p_process_sql_clob=>':P17_COMPANY_ID := :AP_COMPANY_ID;'
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>75843475528150601
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75843881575150602)
,p_process_sequence=>10
...
'      v_page_size number := 5;',
'BEGIN',
'   :P17_PROD_OFFSET := apex_application.g_x02;',
'  -- Open JSON array',
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>75843881575150602
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75844246185150602)
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BEGIN',
'  :P17_APPR_OFFSET := apex_application.g_x02;',
'  -- Open JSON array',
'  apex_json.open_array;',
'',
'  FOR pro_rec IN (',
...
'    FROM XXMRKT.XXMRKT_APPROVAL_SETUP A, XXMRKT.XXMRKT_MARKETPLACE_USERS B',
'    WHERE A.COMPANY_ID = :P17_COMPANY_ID',
'    AND A.COMPANY_CODE = :AP_COMPANY_CODE',
'    AND A.USERNAME = B.USER_ID',
'    AND B.CATEGORY = ''USER''',
'   -- AND COMPANY_TYPE = ''Loan Services''',
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>75844246185150602
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(75844623719150603)
...
''))
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>75844623719150603
);
